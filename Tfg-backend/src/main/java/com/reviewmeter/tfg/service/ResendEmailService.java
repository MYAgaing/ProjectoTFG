...
public class ResendEmailService {
    ...
    /**
     * Envía el email de verificación usando Resend API.
     *
    ...
    public void enviarEmailVerificacion(String destinatario, String nombre, String token) {
        try {
            logger.info("Iniciando envío de email de verificación a: {} usando Resend", destinatario);
            ...
            logger.info("Email de verificación enviado exitosamente a: {} (ID: {})", destinatario, data.getId());

        } catch (ResendException e) {
            logger.error("Error de Resend al enviar email de verificación a {}: {}", 
